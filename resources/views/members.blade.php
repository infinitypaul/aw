...
<nav class="left-menu" left-menu>
    <div class="logo-container">
        <a href="index.html" class="logo">
            <img src="{{asset('member/assets/common/img/logo.png')}}" alt="Clean UI Admin Template" />
            <img class="logo-inverse" src="{{asset('member/assets/common/img/logo-inverse.png')}}" alt="Clean UI Admin Template" />
        </a>
    </div>
                    ...
                    <div class="widget-body clearfix">
                        <div class="conversation-block custom-scroll" style="height: 260px">
                            ...
                            <div class="conversation-item you">
                                <div class="s1">
                                    <a class="avatar" href="javascript:void(0);">
                                        <img src="{{asset('member/assets/common/img/temp/avatars/4.jpg')}}" alt="Alternative text to the image" />
                                    </a>
                                </div>
                                <div class="s2">
                                    <strong>Donald Trump</strong>
                            ...
                            <div class="conversation-item">
                                <div class="s1">
                                    <a class="avatar" href="javascript:void(0);">
                                        <img src="{{asset('member/assets/common/img/temp/avatars/3.jpg')}}" alt="Alternative text to the image" />
                                    </a>
                                </div>
                                <div class="s2">
                                    <strong>David Scott</strong>
